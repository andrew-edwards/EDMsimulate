...
Now trying full simulation of plotting lagged data
<!-- If this doesn't run then uncomment the above chunk and try that, comment -->
<!-- this one -->
```{r, animate.lagged, animation.hook='gifski', fig.dim = c(7, 9), interval = 0.5}
   # Tweak fig.dim to line up panels better
plotPanelMovie.X(Nx.lags) #, end = 20)
```
