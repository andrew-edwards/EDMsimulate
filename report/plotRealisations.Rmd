...
# larkin_args = list( run_stan = TRUE,
# 										prior_mean_alpha = 2,
...
# 										prior_sd_sigma = 0.25)
# ricker_args <- list(run_stan = TRUE,
# 									 prior_mean_alpha = 2,
# 									 prior_mean_beta = -1,
# 									 prior_mean_sigma = 0.5,
# 									 prior_sd_alpha = 0.5,
...
# To revise, to account for R_t
run.out <- run$res_realisations %>% dplyr::mutate(absErr_edm = 
...
forecast_data <- tidyr::pivot_longer(run.out, c(R_prime_T_edm_fit, 
																						R_prime_T_lar_fit,
																						R_prime_T_ric_fit), 
															names_to="forMethod", 
